...
const ABI = require("../artifacts/contracts/hindu_god.sol/hindu_god.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("hindu_god");
  const nft = await NFT.attach("0xb828D089C9b7f2b4EC9eD4eB6BC567eD31E940Dd");

// This script batch mints hindu_god ERC721A tokens.
...
async function main() {
  ...
  const contractAddress = "0xb828D089C9b7f2b4EC9eD4eB6BC567eD31E940Dd";

  // Get the contract factory and attach it to the signer

  const IndianNFT = await ethers.getContractFactory("hindu_god", signer);
